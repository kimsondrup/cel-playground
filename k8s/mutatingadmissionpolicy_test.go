...
func TestMutationEval(t *testing.T) {
	tests := []struct {
		...
		// not as a Go error and not as a panic.
		...
		// same way. These two cases cover convertMAPV1Beta1/convertMAPV1Alpha1.
		...
		wantWarning:      "No embedded OpenAPI schema for example.com/v1",
		wantDiff:         true,
	}, {
